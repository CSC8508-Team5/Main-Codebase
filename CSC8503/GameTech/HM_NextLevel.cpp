...
HM_NextLevel::HM_NextLevel() {
	...
	NextLevel_btn = new DW_UIImage("NextLevelButton", str.c_str(), { 0.33f, 0.1f }, NCL::Maths::Vector3{ 630.0f,200.0f,0.0f });  // Continue button
	...
	NextLevel_text = new DW_UIText("NextLevelText", "Next Level", 0.7f, NCL::Maths::Vector3{ 570.0f,190.0f,0.0f }, NCL::Maths::Vector3{ 1.0f,1.0f,1.0f }); // play again text
