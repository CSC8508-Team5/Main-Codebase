...
void DW_UITextRenderer::Init() {
	...
	std::string font_name = NCL::Assets::FONTSSDIR + "Antonio-Bold.ttf";
	if (font_name.empty())
	{
...
void DW_UITextRenderer::RenderText(std::string text, float x, float y, float scale, NCL::Maths::Vector3 color) {
