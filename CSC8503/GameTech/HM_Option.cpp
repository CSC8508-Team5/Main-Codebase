...
HM_Option::HM_Option(NCL::CSC8503::AudioSystem* audio) {
	...
	Volume_text = new DW_UIText("Volumetext", "Volume : " + std::to_string((int)(volume * 10)), 0.7f, NCL::Maths::Vector3{ 560.0f,390.0f,0.0f }, NCL::Maths::Vector3{ 1.0f,1.0f,1.0f }); // option text
