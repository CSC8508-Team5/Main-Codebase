...
HM_Option::HM_Option() {
	...
	Close_text = new DW_UIText("Closetext", "Close", 0.7f, NCL::Maths::Vector3{ 590.0f,140.0f,0.0f }, NCL::Maths::Vector3{ 1.0f,1.0f,1.0f }); // Close text
	Volume_btn = new DW_UIImage("VolumeBG", str.c_str(), { 0.33f, 0.1f }, NCL::Maths::Vector3{ 630.0f,400.0f,0.0f });  // Volume down button
	Volume_text = new DW_UIText("Volumetext", "Volume : " + std::to_string(Volume), 0.7f, NCL::Maths::Vector3{ 560.0f,390.0f,0.0f }, NCL::Maths::Vector3{ 1.0f,1.0f,1.0f }); // option text
	...
	VolumeUp_text = new DW_UIText("VolumeUp", "+", 1.5f, NCL::Maths::Vector3{ 815.0f,380.0f,0.0f }, NCL::Maths::Vector3{ 0.86f,0.078f,0.235f }); // Volume up text
	VolumeDown_text = new DW_UIText("VolumeDown", "-", 1.5f, NCL::Maths::Vector3{ 420.0f,380.0f,0.0f }, NCL::Maths::Vector3{ 0.86f,0.078f,0.235f }); // Volume Down text
...
void HM_Option::ClickFunc(const std::string& str) {
	...
	if (str == "CloseButton") {
		...
		{
			Volume++;
			Volume_text->SetText("Volume : " + std::to_string(Volume));
		}
