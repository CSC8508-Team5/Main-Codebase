...
HM_PauseMenu::HM_PauseMenu(NCL::LanguageManager* lm) {
	...
	Continue_btn = new DW_UIImage("ContinueButton", str.c_str(), { 0.33f, 0.1f }, NCL::Maths::Vector3{ 630.0f,210.0f,0.0f });  // Continue button
	Back_btn = new DW_UIImage("MenuButton", str.c_str(), { 0.33f, 0.1f }, NCL::Maths::Vector3{ 630.0f,110.0f,0.0f });  // Back to main menu button
